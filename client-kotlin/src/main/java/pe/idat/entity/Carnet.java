...
public class Carnet implements Serializable{
    ...
    public Carnet(Integer carnetId, String codigo, String tcarnet, Integer nprestamos) {
    ...
    public Integer getNprestamos() {
        return nprestamos;
    }

    public void setNprestamos(Integer nprestamos) {
        this.nprestamos = nprestamos;
    }
